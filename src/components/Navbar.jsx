...
const NavButton = ({ title, customFunc, icon, color, dotColor}) => (
    <TooltipComponent content={title} position='BottomCenter'>
      ...
      style={{ color }} 
      className="relative text-x1 rounded-full pt-4
      hover:bg-light-gray"
      >
         ...
         icon={<RiNotification3Line />}
          ...
          >
            <div className='flex items-center gap-2 cursor-pointer p-1
             ...
             >
               <img src={avatar} alt='foto-perfil' className='rounded-full
                w-8 h-8' />
                <p>
                  <span className='text-gray-400 text-14'>Hi, </span> {' '}
                  <span className='text-gray-400 font-bold ml-1'>Maicon</span>
                </p>
                <RiArrowDropDownLine className='text-gray-400 text-14' />
